...
function editViewTemplate(data, validationObj) {
    return html`
...
export async function showEditView(ctx) {
    ...
    ctx.renderView(editViewTemplate(data, {}));
}
...
async function onEdit(event) {
    ...
    if (!isValidForm) {
        return renderTemplate(editViewTemplate(data, validationObj));
    }

    await updateItem(itemId, data, token);
